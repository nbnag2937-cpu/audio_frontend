    ...
    <div>
      ...
      <div className="bg-[#FFF3F7] border-y py-5 border-[#F1D6E0] text-black">
        <div className="mx-auto flex w-full max-w-360 flex-col gap-5 px-4 py-5 sm:px-6 md:px-8 lg:px-20 xl:px-70">
          ...
          <span className="text-black/70">
            ● <span className="text-[#7A1140] font-bold">Dữ liệu sử dụng:</span>{" "}
          ...
          <span className="text-black/70">
            ...
            <span className="font-bold text-[#7A1140]">Google AdSense</span>, để
          ...
          <span className="text-black/70">
            Chúng tôi{" "}
            <span className="font-bold text-[#7A1140]">không bán</span> thông
            tin cá nhân của bạn. Thông tin chỉ được chia sẻ với các nhà cung cấp
            dịch vụ cần thiết (như đối tác quảng cáo, phân tích) hoặc khi pháp
            luật yêu cầu.
          </span>
